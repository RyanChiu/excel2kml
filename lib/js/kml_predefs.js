...
function polygonwith(dp, secname, secnum, srvs, polygon) {
	var iaas = "";
	iaas += "<Placemark><name>";
	iaas += secname;
	iaas += "</name><ExtendedData>\n";
	iaas += '<Data name="区域"><value>' + dp + '</value></Data>\n';
	iaas += '<Data name="业务总数"><value>' + srvs + '</value></Data>\n';
	iaas += '<Data name="接入区编码"><value>' + secnum + '</value></Data>\n';
	iaas += '</ExtendedData>\n';
	iaas += '<styleUrl>#' + polygonstylewith(srvs, true) + '</styleUrl>\n';
	iaas += '\
		<Polygon>\n\
